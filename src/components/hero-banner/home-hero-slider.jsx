...
const sliderData = [
  {
    id: 1,
    pre_title: { text: "Giá chỉ từ", price: 10000000 },
    title: "Bộ sưu tập đồng hồ thông minh tốt nhất 2024",
    subtitle: {
  ...
  {
    id: 2,
    pre_title: { text: "Giá chỉ từ", price: 20000000 },
    title: "Bộ sưu tập máy tính bảng tốt nhất 2024",
    subtitle: {
      text_1: "Ưu đãi độc quyền ",
      percent: 10,
      text_2: "của tuần này",
  ...
  {
    id: 3,
    pre_title: { text: "Giá chỉ từ", price: 15000000 },
                  ...
                  <div className="col-xl-5 col-lg-6 col-md-6">
                    <div className="tp-slider-content p-relative z-index-1">
                      <span>
                        {item.pre_title.text}{" "}
                        <b>
                          {item.pre_title.price.toLocaleString("it-IT", {
                            style: "currency",
                            currency: "VND",
                          })}
                        </b>
